...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS $outSchema.BMI_measures_raw
# MAGIC (
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS $outSchema.BMI_Measures_Aggregated
# MAGIC (
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS $outSchema.BMI_Measures_CSV
# MAGIC (
# MAGIC    RPStartDate     DATE
# MAGIC   ,RPEndDate       DATE
# MAGIC   ,IndicatorFamily STRING
