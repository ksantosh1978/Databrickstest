...
# DBTITLE 1,Transfer_AMU_Obstetric metric - Denominator
# MAGIC %sql
...
# MAGIC
# MAGIC INSERT INTO $outSchema.NMPA_Transfer_AMU_Obstetric_Denominator
# MAGIC                        
# MAGIC -- Mbrrace
...
# MAGIC   , 'Transfer_AMU_Obstetric' Indicator
...
# MAGIC WHERE SettingIntraCare = '02'
...
# DBTITLE 1,Transfer_AMU_Obstetric metric - Numerator
# MAGIC %sql
# MAGIC /* Mbrrace cases only & make a distinct count of Person_ID_Mother where SettingIntraCare is 04 (Home, NHS) or 05 (Home, private) */
# MAGIC
# MAGIC INSERT INTO $outSchema.NMPA_Transfer_AMU_Obstetric_Numerator
# MAGIC
# MAGIC --Mbrrace
# MAGIC SELECT Mbrrace_Grouping_Short AS Org_Code
# MAGIC   , Mbrrace_Grouping AS Org_Name
...
# MAGIC
# MAGIC FROM $outSchema.NMPA_TRANSFER_IN_BIRTH_SETTING_RAW_GEOGRAPHY
# MAGIC WHERE SettingIntraCare = '02' AND SettingPlaceBirth = '01'
# MAGIC GROUP BY Mbrrace_Grouping_Short, Mbrrace_Grouping 
# MAGIC
# MAGIC UNION
# MAGIC -- Provider
...
# MAGIC   FROM $outSchema.NMPA_Transfer_AMU_Obstetric_Denominator
# MAGIC   EXCEPT
# MAGIC   SELECT Org_Code, Org_Name, Org_Level, ReportingPeriodStartDate, ReportingPeriodEndDate, IndicatorFamily, Indicator
# MAGIC   FROM $outSchema.NMPA_Transfer_AMU_Obstetric_Numerator
# MAGIC ) x
# MAGIC
...
# MAGIC   
# MAGIC from 
# MAGIC   $outSchema.NMPA_Transfer_AMU_Obstetric_Denominator d),
# MAGIC  
# MAGIC num as (
# MAGIC  
# MAGIC select 
...
# MAGIC   Value
# MAGIC from 
# MAGIC   $outSchema.NMPA_Transfer_AMU_Obstetric_Numerator n)
# MAGIC   
# MAGIC select 
# MAGIC   den.Org_Code
# MAGIC   ,den.Org_Name
...
dbutils.notebook.exit("Notebook: NMPA_Transfer_AMU_Obstetric ran successfully")